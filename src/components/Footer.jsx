...
function Footer() {
  return (
    <footer className="style-2  pt-2">
      <div className="footer-top dark-view padding-tb">
        <div className="container">
          <div className="row g-4 row-cols-xl-3 row-cols-sm-1 row-cols-md-1 justify-content-center">
            {/* 1st col */}
            <div className="col">
                  ...
                  <div className="content">
                    ...
                    <ul className="lab-ul office-address">
                      {addressList.map((val, i) => (
                        <li key={i} className={`${val.iconName} p-1`}>
                          {val.text}
                        </li>
                      ))}
                    </ul>
